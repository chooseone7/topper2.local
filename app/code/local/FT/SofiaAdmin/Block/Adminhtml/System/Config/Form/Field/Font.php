...
class FT_SofiaAdmin_Block_Adminhtml_System_Config_Form_Field_Font extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="sofia_gfont_preview'.$time.'" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
		<script>
        ...
        googleFontPreviewModel'.$time.'.prototype = {
            initialize : function()
            {
                ...
                this.previewElement = $("sofia_gfont_preview'.$time.'");
                this.loadedFonts = "";
